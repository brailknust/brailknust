          ...
          <div className="mt-5 grid gap-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <label className="grid gap-2 text-sm font-semibold">
                Due date and time
                <input name="dueAt" type="datetime-local" aria-describedby="task-due-date-help" className="h-11 rounded-md border border-border bg-background px-3 text-sm font-normal" />
              ...
              <label className="grid gap-2 text-sm font-semibold">
                ...
                <input name="reminderAt" type="datetime-local" className="h-11 rounded-md border border-border bg-background px-3 text-sm font-normal" />
                <span className="text-xs font-normal text-muted">BRAIL will notify you at this time.</span>
              </label>
            </div>
            <select name="priority" defaultValue="MEDIUM" aria-label="Task priority" className="h-11 rounded-md border border-border bg-background px-3 text-sm">
                  ...
                  <div className="mt-4 flex flex-wrap items-center justify-between gap-2">
                    ...
                    <form action={deleteTask}>
                      ...
                      <ConfirmSubmitButton
                        ...
                        className="rounded-md border border-red-300 px-3 py-2 text-sm font-semibold text-red-700 transition hover:border-red-600 hover:text-red-800"
                      >
                        Delete
                      </ConfirmSubmitButton>
                    </form>
